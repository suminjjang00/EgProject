<?php
namespace orderVali_class;

use FormInterface_class\FormInterface_class;
require "./FormInterface_class.php";

class orderVali_class implements FormInterface_class{

  function show_form($errors=array()){
    $defaults = array('delivery'=>'yes',
                'size'=>'medium');
    StaticFactory_class::createFactory('order',$defaults);
  }
